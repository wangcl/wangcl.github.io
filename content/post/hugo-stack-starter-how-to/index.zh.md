...
1. 打开 [hugo-stack-starter](https://github.com/liu-houliang/hugo-stack-starter) 仓库，点击右上角的 Use this template

2. 创建新仓库时，命名为 "用户名.github.io"（如有旧版本，建议将旧版本改名备份）
